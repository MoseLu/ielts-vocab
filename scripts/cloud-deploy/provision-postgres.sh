...
chmod 700 "$(dirname "${env_file}")"
{
  ...
  echo "# Optional: speaking score calibration override for ai-execution-service."
  echo "# SPEAKING_ASSESSMENT_BAND_THRESHOLDS_JSON=[[95,9.0],[89,8.5],[83,8.0],[76,7.5],[69,7.0],[62,6.5],[55,6.0],[48,5.5],[41,5.0],[34,4.5],[27,4.0],[20,3.5],[13,3.0],[6,2.5],[1,2.0],[0,0.0]]"
