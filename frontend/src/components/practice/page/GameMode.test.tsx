...
describe('GameMode', () => {
  ...
  it('renders the main game map with real campaign and dimension progress', async () => {
    ...
    expect(mapImages).toContain('https://oss.example/game-assets/study-campus/desktop/map.png')
    expect(mapImages.every(src => !src.includes('/ui/'))).toBe(true)
    ...
    expect(document.querySelector('.practice-game-map__prd-hud')).not.toBeNull()
