...
app = create_service_shell_app(
    ...
    version='0.1.0',
    readiness_checks={
        'database': make_sqlalchemy_readiness_check(identity_flask_app.config['SQLALCHEMY_DATABASE_URI']),
    },
    extra_health={'auth_compatibility': True},
)
app.mount('/', WSGIMiddleware(identity_flask_app))


if __name__ == '__main__':
    import uvicorn

    uvicorn.run(app, host='0.0.0.0', port=int(os.environ.get('IDENTITY_SERVICE_PORT', '8101')))
