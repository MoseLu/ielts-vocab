...
def _apply_wrong_word_snapshot(record: UserWrongWord, payload: dict) -> tuple[int, int, list[tuple[str, bool]]]:
    ...
    return previous_summary['wrong_count'], merged_summary['wrong_count'], attempts
