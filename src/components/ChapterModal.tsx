...
interface ProgressApiResponse {
  chapter_progress: Record<string | number, ChapterProgress>
}
...
function ChapterModal({ book, progress, onClose, onSelectChapter }: ChapterModalProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const chaptersData: ChaptersApiResponse = await chaptersRes.json()
  ...
  const getCurrentChapterId = (): string | number | null => {
