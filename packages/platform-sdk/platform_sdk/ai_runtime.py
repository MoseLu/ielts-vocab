...
def create_ai_flask_app(config_class=None) -> Flask:
    app = Flask(__name__)
    ...
    with app.app_context():
        bootstrap_service_schema('ai-execution-service')
