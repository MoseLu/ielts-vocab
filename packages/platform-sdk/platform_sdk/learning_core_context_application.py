...
from platform_sdk.catalog_provider_adapter import list_vocab_books, serialize_effective_book_progress
from platform_sdk.learning_repository_adapters import learning_stats_repository
from platform_sdk.ai_learning_summary_support import alltime_words_display


def build_learning_core_context_payload(user_id: int) -> dict:
    ...
    chapter_progress_by_book: dict[str, list] = defaultdict(list)
    ...
    total_learned = alltime_words_display(user_id, total_effective_words)
