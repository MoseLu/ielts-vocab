...
from platform_sdk.learning_core_transport import learning_core_bp
...
def create_learning_core_flask_app(config_class=None) -> Flask:
    app = Flask(__name__)
    ...
    init_middleware(app)
    app.register_blueprint(learning_core_bp)

    with app.app_context():
        bootstrap_service_schema('learning-core-service')
